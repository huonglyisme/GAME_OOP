...
public class CastleFinal extends Map {

    private static String mapPath = "asset/map/CASTLE_FINAL.tmx";

    public CastleFinal() {
        super(MapFactory.MapType.CASTLE_FINAL, mapPath);

        addEnemy(EntityFactory.EntityName.RABITE10);
        addEnemy(EntityFactory.EntityName.RABITE11);
        addEnemy(EntityFactory.EntityName.RABITE12);
        addEnemy(EntityFactory.EntityName.RABITE20);
    }
