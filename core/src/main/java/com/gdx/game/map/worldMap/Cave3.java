...
public class Cave3 extends Map {

    private static String mapPath = "asset/map/CAVE_3.tmx";

    public Cave3() {
        super(MapFactory.MapType.CAVE_3, mapPath);

        addEnemy(EntityFactory.EntityName.RABITE4);
        addEnemy(EntityFactory.EntityName.RABITE5);
    }
